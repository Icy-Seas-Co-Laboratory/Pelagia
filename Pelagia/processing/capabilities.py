    ...
    return {
        ...
        "api": {
            "endpoints": {
                ...
                "delete_live_sandbox": "/live/sandbox/{sandbox_frame_id}",
...
def preprocessing_capabilities(config: ProcessingConfig) -> dict[str, Any]:
    ...
    return {
        ...
        "defaults": {
            "preprocessing": {
                "apply_mask": config.preprocessing.apply_mask,
                "crop_enabled": config.preprocessing.crop_enabled,
                "crop_x": config.preprocessing.crop_x,
                "crop_y": config.preprocessing.crop_y,
                "crop_w": config.preprocessing.crop_w,
                "crop_h": config.preprocessing.crop_h,
                "invert_intensity": config.preprocessing.invert_intensity,
            },
            "stored_field_correction": {
                "background": {
                    "min_field_value": config.preprocessing.background_min_field_value,
                    "max_field_value": config.preprocessing.background_max_field_value,
                },
                "flatfield_profile": {
                    "min_field_value": config.flatfield.flatfield_min_field_value,
                    "max_field_value": config.flatfield.flatfield_max_field_value,
                },
            },
